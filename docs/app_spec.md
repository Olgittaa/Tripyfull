...
> This is the design spec as it stood in **July 2026**. It is kept for its reasoning, its
> personas and its gap list (§9), and it is **not maintained**. Nothing here decides what the
> app should do. The single specification is [`features.md`](features.md); where the two
> differ, `features.md` and the code are right. Do not edit this file to record a change —
> edit `features.md`.

**Status:** v1 · July 2026 · archived 2026-09-17.
