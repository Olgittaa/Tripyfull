...
/**
 * Resolves a Google Maps share link (incl. maps.app.goo.gl short links) into
 * name/coordinates/photo: follows redirects, then reads Open Graph metadata
 * (served to crawlers) for the place name, photo and description, plus
 * coordinates from the resolved URL.
 */
@Service
